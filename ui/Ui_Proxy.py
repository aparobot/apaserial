...
class Ui_Proxy(Ui_MainWindow):
    ...
    def onPortOpened(self):
        ...
        self.status_label.setStyleSheet("background-color: rgb(85, 255, 0);")
    ...
    def onPortClosed(self):
        ...
        self.status_label.setStyleSheet("background-color: rgb(238, 238, 238);")
